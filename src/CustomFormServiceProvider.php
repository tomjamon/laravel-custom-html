...
class LaravelCustomFormServiceProvider extends ServiceProvider implements DeferrableProvider {
    ...
    protected $directives = [
        ...
        'linkAsset','linkSecureAsset','linkRoute','linkAction','mailto','email','ol','ul',
        'dl','meta','tag','open','model','close','token','label','input','text','password',
        'hidden','email','tel','number','date','datetime','datetimeLocal','time','url',
